...
<div id="tab-content-basic" class="tab-content">
   ...
   <div class="theme_option_field cf theme_option_field_ac open active">
    ...
    <div class="theme_option_field_ac_content">
     ...
     <h4 class="theme_option_headline2"><?php _e( 'Font size of headline (mobile)', 'tcd-w' ); ?></h4>
     ...
     <div style="<?php if($options['use_overlay_404'] == 1) { echo 'display:block;'; } else { echo 'display:none;'; }; ?>">
      ...
      <p><input type="text" name="dp_options[overlay_color_404]" value="<?php echo esc_attr( $options['overlay_color_404'] ); ?>" data-default-color="#000000" class="c-color-picker"></p>
      <h4 class="theme_option_headline2"><?php _e('Overlay color transparency', 'tcd-w');  ?></h4>
      <p><?php _e('Please specify the number of 0.1 from 0.9. Overlay color will be more transparent as the number is small.', 'tcd-w');  ?></p>
      <p><input class="hankaku" style="width:70px;" type="number" max="1" min="0" step="0.1" name="dp_options[overlay_opacity_404]" value="<?php echo esc_attr( $options['overlay_opacity_404'] ); ?>" /></p>
     </div>
