...
<div id="site_loader_overlay">
 <div id="site_loader_logo"<?php if($logo_image_mobile) { echo ' class="has_mobile_logo"'; }; ?>>
  <div id="site_loader_logo_inner">
   ...
   <?php if($options['load_type4_catch']){ ?><p class="rich_font_<?php echo esc_attr($options['load_type4_catch_font_type']); ?>"><?php echo wp_kses_post(nl2br($options['load_type4_catch'])); ?></p><?php }; ?>
  </div>
 </div>
</div>
<?php } else { ?>
