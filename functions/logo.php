...
<h3 class="logo">
 <a href="<?php echo esc_url($url); ?>/" title="<?php echo esc_attr($title); ?>">
  ...
  <?php } else { ?>
  <span class="pc_logo_text" style="font-size:<?php echo esc_html($options['logo_font_size_footer']); ?>px;"><?php echo esc_html($title); ?></span>
  <?php }; ?>
  <?php if( ($options['use_logo_image_footer_mobile'] == 'yes') && $logo_image_mobile ){ ?>
  <img class="mobile_logo_image" src="<?php echo esc_attr($logo_image_mobile[0]); ?>?<?php echo esc_attr(time()); ?>" alt="<?php echo esc_attr($title); ?>" title="<?php echo esc_attr($title); ?>" width="<?php echo esc_attr($mobile_image_width); ?>" height="<?php echo esc_attr($mobile_image_height); ?>" />
  <?php } else { ?>
  <span class="mobile_logo_text" style="font-size:<?php echo esc_html($options['logo_font_size_footer_mobile']); ?>px;"><?php echo esc_html($title); ?></span>
  <?php }; ?>
 </a>
</h3>
